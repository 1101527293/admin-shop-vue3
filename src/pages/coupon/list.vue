        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="操作" width="180" align="center">
                <template #default="scope">
                    ...
                    <el-popconfirm v-if="scope.row.statusText == '领取中'" title="是否要让该优惠券失效？" confirmButtonText="确认"
        ...
        <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
            <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
                ...
                <el-form-item label="最低使用价格" prop="min_price">
                    <el-input type="number" v-model="form.min_price" placeholder="最低使用价格"></el-input>
                </el-form-item>
                ...
                <el-form-item label="活动时间">
                    <el-date-picker :editable="false" v-model="timerange" type="datetimerange" range-separator="~"
                        start-placeholder="开始时间" end-placeholder="结束时间" value-format="YYYY-MM-DD HH:mm:ss" />
                </el-form-item>

                <el-form-item label="描述" prop="desc">
                    <el-input type="textarea" :rows="5" v-model="form.desc" placeholder="描述"></el-input>
                </el-form-item>
            </el-form>
