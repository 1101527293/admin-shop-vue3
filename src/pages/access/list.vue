        ...
        <el-tree :data="tableData" :props="{ label:'name', children:'child'}" node-key="id"
            ...
            <template #default="{ node, data }">
                <div class="custom-tree-node">
                    ...
                    <el-icon v-if="data.icon && data.icon!='22'" :size="16" class="mr-1">
                    ...
                    <div class="ml-auto">
                        ...
                        <el-popconfirm title="是否要删除该权限？" confirmButtonText="确认" cancelButtonText="取消"
        ...
        <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
            <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
                ...
                <el-form-item label="请求方式" prop="method" v-if="form.menu==0">
                    <el-select v-model="form.method" class="m-2" placeholder="选择请求方式">
